...
public abstract class MovementStrategy implements Comparable, MarshmallowConstants {
    ...
    public abstract MovementData getMovementData(Enemy enemy, MyTank robot);
    ...
    double distanceExtra(Enemy enemy, MyTank robot, double cornerMargin) {
    ...
    boolean doRam(Enemy enemy, MyTank robot) {
