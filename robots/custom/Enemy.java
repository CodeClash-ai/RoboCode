...
// Enemy. Keeping track of a MyTank Enemy.
...
public class Enemy implements MarshmallowConstants {
    ...
    public Enemy(MyTank robot, String name, Map tuningFactors,
...
class Tracker implements MarshmallowConstants {
    ...
    Tracker(Enemy enemy, MyTank robot) {
        this.enemy = enemy;
        this.robot = robot;
    }
