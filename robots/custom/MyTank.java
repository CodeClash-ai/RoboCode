...
// Source: https://github.com/PEZ/Bots/blob/HEAD/pez/mini/Pugilist.java
...
//MyTank, by PEZ. Although a pugilist needs strong and accurate fists, he/she even more needs an evasive movement.

//MyTank explores two major concepts:
...
//$Id: MyTank.java,v 1.3 2006/05/15 04:47:35 peter Exp $
...
class Wave extends Condition {
	...
	double gunBearing(Point2D target) {
		return MyTank.absoluteBearing(gunLocation, target);
	}
...
class EnemyWave extends Wave {
	...
	public EnemyWave(MyTank pugilist) {
        super(pugilist);
    }
