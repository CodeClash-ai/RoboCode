...
// Source: https://github.com/lucasgch/titan/blob/HEAD/BT_7274_V6.6.java
// Author: lucasgch   License: unspecified
...
public class MyTank extends AdvancedRobot {
    ...
    class Onda extends Condition {
        ...
        public boolean test() {
            ...
            if (distanciaPercorrida > posicaoCanhao.distance(posicaoAlvo) - MARGEM_PAREDE) {
                ...
                MyTank.this.ondasAtivas.remove(this); 
        ...
        double offsetAnguloMaisVisitado() {
            ...
            if (MyTank.ultimoRoundAvaliacao != roundAtual) {
                ...
                if (melhorVGDestaAvaliacao != -1) {
                    MyTank.armaTravada = melhorVGDestaAvaliacao;
                    bot.escolheuArmaNaturalmente = true;
                } else {
                    bot.escolheuArmaNaturalmente = false;
                }
                MyTank.ultimoRoundAvaliacao = roundAtual;
            }
            
            if (MyTank.armaTravada != -1) {
                bot.escolheuArmaNaturalmente = true;
            }

            int melhorVG = MyTank.armaTravada;
            ...
            boolean forcarPorDerrotas = (bot.alvo != null && bot.alvo.nome != null && MyTank.derrotasSeguidas.getOrDefault(bot.alvo.nome, 0) > 5);
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        if (getOthers() > 1) { 
            ...
            // INTEGRAÇÃO: Atualizando perfis de predição do arquivo upado
            double hChange1v1 = Utils.normalRelativeAngle(inimigo.direcao - inimigo.ultimaDirecao);
            inimigo.avgVelocity1v1 = (inimigo.velocidade * 0.7) + (inimigo.avgVelocity1v1 * 0.3);
            inimigo.avgHeadingChange1v1 = (hChange1v1 * 0.7) + (inimigo.avgHeadingChange1v1 * 0.3);
            ...
            // Impede Surfing falso no Clinger
