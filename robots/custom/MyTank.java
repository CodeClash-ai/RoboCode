...
// Source: https://github.com/namnguyenthanhwork/RoboCode-GuessFactor-MeleeStrategy/blob/HEAD/Cham.java
// Author: namnguyenthanhwork   License: unspecified
	...
	static class Wave extends Condition {
		...
		private int currentBin() {
			int bin = (int) Math.round(((Utils.normalRelativeAngle
					(MyTank.Utility.absoluteBearing(gunLocation, targetLocation) - bearing)) /
