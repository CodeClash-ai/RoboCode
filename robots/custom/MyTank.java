		...
		this.addCustomEvent(new Condition("there's_an_obstacle_ahead")
		{
			public boolean test()
			{
				return !tooCloseToWall && (
					MyTank.this.getX() <= wallMargin ||
					MyTank.this.getX() >= MyTank.this.getBattleFieldWidth() - wallMargin ||
					MyTank.this.getY() <= wallMargin ||
					MyTank.this.getY() >= MyTank.this.getBattleFieldHeight() - wallMargin
				);
			}
		});
