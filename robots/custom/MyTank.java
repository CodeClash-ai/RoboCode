...
public class MyTank extends AdvancedRobot {
    ...
    private void aimAndFire(double absBearing) {
        ...
        double W = 0.0;  // vs pez__haikupoet REVERTED to W=0.0 (R0 winning config). R1 teammate switched to W=1.0 head-on off a BIASED replay -> LOST the match (R0 opus WON 39044 vs 14634 realHR 35.2% 24 losses; R1 opus LOST 23359 vs 25398 realHR 21.5% 136 losses). Unbiased in-game hit rate is DECISIVE: W=0.0 full lead beats W=1.0 head-on for this moderate near-straight mover. Do NOT trust the W-sweep replay (reactivity bias). See README round-2 haikupoet note.
    ...
    private void doMovement() {
        ...
        // vs johan_adriaans__berendbotje (FAST HEAVY spinner avgdh 0.11, LEAD gun
        // offset 0.45 rad). We were LOSING 96/120 sims camping ~200-250px where the
        // hit exchange is EVEN (ratio ~1.06). UNBIASED hit density by distance (120
        // sims): 100-300px ratio ~1.06 (even, ~57k ticks), 300-400px ratio 3.38
        // (our 4.5/1k vs enemy 1.3/1k -- its LEAD gun COLLAPSES beyond 300px while
