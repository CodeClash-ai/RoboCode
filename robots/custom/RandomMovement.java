...
public class RandomMovement extends MovementStrategy implements MarshmallowConstants {
    ...
    public MovementData getMovementData(Enemy enemy, MyTank robot) {
    ...
    double distanceExtra(Enemy enemy, MyTank robot) {
